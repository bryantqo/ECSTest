module Animation.Model exposing (Animation(..), ArcMotion, CubicCurveMotion, Interpolation(..), Motion, PathCommand(..), Property(..), QuadraticCurveMotion, ShadowMotion, Step(..), Tick(..), Timing, alreadyThere, isCmdDone, isDone, mapPathMotion, mapToMotion, matchPoints, propertyName, refreshTiming, replaceProps, resolveSteps, setPathTarget, setTarget, startTowards, step, stepInterpolation, stepPath, tolerance, updateAnimation, vTolerance, zipPropertiesGreedy)
